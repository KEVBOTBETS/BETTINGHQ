...
const require=createRequire(import.meta.url),C=require('../moneyling-core.js');
...
console.log('Moneyling: winner selection, timing, stale feeds, missing inputs, ties, duplicate games and immutable picks passed');
