...
function predictionsBlock() {
  ...
  <div class="body">
    <div class="note">Only verified pregame snapshots are scored — bet or not.
      ${Number(P.scope?.excluded_graded || 0)} legacy graded records excluded because their snapshot time or season could not qualify.
      Those records remain in the source history; they do not train calibration.</div>
    ${statRow([
